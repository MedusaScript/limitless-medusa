...
function lib.Interface(str)
	if str == "hide" then
		if get_hidden_gui or gethui then
			...
			Notif:NotifyUser(`<b>Brutality Hub running in {identifyexecutor()} Environment</b>`,10)
			return Main
...
function lib:ErrorReader(func,ssd)
	...
	if not shit and shut == false then
		...
		SendMessage("https://discord.com/api/webhooks/1238814420730249256/5HrILgPs4i6KejfyN5auAH19cW4cxoQQl3PPVmRfbWr8pkM9DCFLvFeJZjS5TK4aMyKT","An error has occured when running Brutality Hub.```diff\n- " .. dick .. "\n" .. debug.traceback() .. "\n```")
	end
end
